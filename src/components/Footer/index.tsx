      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-1 font-medium dark:text-white text-dark">
              Help & Support
            </h2>
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                73/1 Diamond Tower, College Road, Matuail.
              </li>

              <li>
                <a href="#" className="flex items-center gap-4.5">
                  <PhoneCall size={28} className="text-pink" />
                  (+880) 1719-681150
                </a>
              </li>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              ...
              <Link href={"#"}>
                <Twitter size={20} className="hover:text-pink cursor-pointer" />
              </Link>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-pink" href="#">
                  My Account
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-pink ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark dark:text-gray-4 font-medium">
              ...
              <span className="text-pink">E-commerce</span>.
            </p>
