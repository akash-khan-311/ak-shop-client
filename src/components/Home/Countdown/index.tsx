          ...
          <div className="max-w-[422px] w-full">
            ...
            >
              ...
              <div>
                ...
                <span className="block text-custom-sm text-dark dark:text-gray-5 text-center">
                  Days
                </span>
              </div>
            ...
            <a
              href="#"
              className="inline-flex font-medium text-custom-sm text-white bg-pink py-3 px-9.5 rounded-md ease-out duration-200 hover:bg-pink-dark mt-7.5"
            >
              Check it Out!
            </a>
          </div>
