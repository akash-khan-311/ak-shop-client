            ...
            <div className="flex flex-col sm:flex-row xl:flex-col gap-5">
              <div className="w-full relative rounded-[10px] bg-white p-4 sm:p-7.5 dark:bg-dark-2">
                <div className="flex items-center gap-14">
                  <div>
                    <h2 className="max-w-[153px] font-semibold text-dark dark:text-white text-xl mb-20">
              ...
              <div className="w-full relative rounded-[10px] bg-white p-4 sm:p-7.5 dark:bg-dark-2">
                <div className="flex items-center gap-14">
                  <div>
                    <h2 className="max-w-[153px] font-semibold text-dark text-xl mb-20 dark:text-white">
