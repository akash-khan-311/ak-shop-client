...
const HeroCarousal = () => {
  return (
    <Swiper
      ...
      className="hero-carousel dark:bg-dark-2"
    >
      <SwiperSlide>
        <div className=" flex items-center pt-6 sm:pt-0 flex-col-reverse sm:flex-row">
          <div className="max-w-[394px] py-10 sm:py-15 lg:py-24.5 pl-4 sm:pl-7.5 lg:pl-12.5">
            ...
            <a
              href="#"
              className="inline-flex font-medium text-white text-custom-sm rounded-md bg-dark py-3 px-9 ease-out duration-200 hover:bg-pink mt-10"
            >
              Shop Now
            </a>
          </div>
      ...
      <SwiperSlide>
        ...
        <div className="flex items-center pt-6 sm:pt-0 flex-col-reverse sm:flex-row">
          <div className="max-w-[394px] py-10 sm:py-15 lg:py-26 pl-4 sm:pl-7.5 lg:pl-12.5">
            ...
            <h1 className="font-semibold text-dark text-xl sm:text-3xl dark:text-white mb-3">
              <a href="#">True Wireless Noise Cancelling Headphone</a>
            </h1>
