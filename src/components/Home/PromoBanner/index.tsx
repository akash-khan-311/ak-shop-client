      ...
      <Container>
        ...
        <div className="relative z-1 overflow-hidden rounded-lg bg-[#F5F5F7] dark:bg-dark-3 py-12.5 lg:py-17.5 xl:py-22.5 px-4 sm:px-7.5 lg:px-14 xl:px-19 mb-7.5">
          <div className="max-w-[550px] w-full">
            <span className="block font-medium text-xl text-dark dark:text-white mb-3">
              Apple iPhone 14 Plus
            </span>

            <h2 className="font-bold text-xl lg:text-heading-4 xl:text-heading-3 text-dark dark:text-white mb-5">
              UP TO 30% OFF
            </h2>
            ...
            <a
              href="#"
              className="inline-flex font-medium text-custom-sm text-white bg-pink py-[11px] px-9.5 rounded-md ease-out duration-200 hover:bg-pink-dark mt-7.5"
            >
              Buy Now
            </a>
          </div>
        ...
        <div className="grid gap-7.5 grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative z-1 overflow-hidden rounded-lg bg-[#FFECE1] py-10 xl:py-16 px-4 sm:px-7.5 xl:px-10">
            ...
            <div>
              ...
              <p className="max-w-[285px] text-dark text-custom-sm">
