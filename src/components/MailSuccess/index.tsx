    ...
    <>
      ...
      <section className="overflow-hidden py-20 bg-gray-2 dark:bg-dark-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="bg-white dark:bg-dark rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              <h2 className="font-bold text-green text-4xl lg:text-[45px] lg:leading-[57px] mb-5">
                Successful!
              </h2>

              <h3 className="font-medium text-dark dark:text-white text-xl sm:text-2xl mb-3">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 font-medium text-white bg-pink py-3 px-6 rounded-md ease-out duration-200 hover:bg-pink-dark"
              >
                <svg
