  ...
  return (
    <div className="lg:max-w-[455px] w-full">
      ...
      <div className="bg-white dark:bg-dark-2 shadow-1 rounded-[10px]">
        <div className="border-b border-gray-3 dark:border-gray-6 py-5 px-4 sm:px-8.5">
          <h3 className="font-medium text-xl ">Order Summary</h3>
        </div>

        <div className="pt-2.5 pb-8.5 px-4 sm:px-8.5">
          {/* <!-- title --> */}
          <div className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-gray-6">
            <div>
          ...
          {cartItems.map((item, key) => (
            <div
              key={key}
              className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-gray-6"
            >
              <div>
