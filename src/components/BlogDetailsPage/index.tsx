        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-12.5">
            ...
            <div className="lg:max-w-[750px] w-full">
              ...
              <div>
                <span className="flex items-center gap-3 mb-4">
                  <a href="#" className="ease-out duration-200 hover:text-pink">
                    Mar 27, 2022
                  </a>
                ...
                <div className="mt-7.5">
                  <h3 className="font-medium  text-lg xl:text-[26px] xl:leading-[34px] mb-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-10 mt-10">
                  <div className="flex flex-wrap items-center gap-5">
                    ...
                    <ul className="flex flex-wrap items-center gap-3.5">
                      <li>
                        <a
                          className="inline-flex hover:text-white border border-gray-3 bg-white py-2 dark:bg-dark px-4 rounded-md ease-out duration-200 hover:bg-pink hover:border-pink"
                          href="#"
                        >
                          Desktop
                        </a>
            ...
            <div className="lg:max-w-[370px] w-full">
              ...
              <div className="shadow-1 bg-white dark:bg-dark rounded-xl mt-7.5">
                <div className="px-4 sm:px-6 py-4.5 border-b border-gray-3">
                  <h2 className="font-medium text-lg ">Popular Category</h2>
                </div>

                <div className="p-4 sm:p-6">
                  <div className="flex flex-col gap-3">
                    <button className="group flex items-center justify-between ease-out duration-200 hover:text-pink">
                      Desktop
                      <span className="inline-flex rounded-[30px] bg-gray-2 dark:bg-dark-2 text-custom-xs px-1.5 ease-out duration-200 group-hover:text-white group-hover:bg-pink">
                        12
                      </span>
                    </button>
              ...
              <div className="shadow-1 bg-white dark:bg-dark rounded-xl mt-7.5">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-wrap gap-3.5">
                    <a
                      className="inline-flex hover:text-white border border-gray-3 py-2 px-4 rounded-md ease-out duration-200 hover:bg-pink hover:border-pink"
                      href="#"
                    >
                      Desktop
                    </a>
